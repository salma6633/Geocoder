    ...
    <aside className="dashboard-sidebar">
      ...
      <nav className="sidebar-nav">
        <ul>
          ...
          <li className={activeNav === 'api-keys' ? 'active' : ''} onClick={() => setActiveNav('api-keys')}>
            <APIKeysIcon />
            <span>API Keys</span>
          </li>
          <li className={activeNav === 'usage' ? 'active' : ''} onClick={() => setActiveNav('usage')}>
            <UsageIcon />
            <span>Usage</span>
          </li>
          <li className={activeNav === 'logs' ? 'active' : ''} onClick={() => setActiveNav('logs')}>
            <LogsIcon />
            <span>Request Logs</span>
          </li>
          <li className={activeNav === 'notifications' ? 'active' : ''} onClick={() => setActiveNav('notifications')}>
            <NotificationsIcon />
            <span>Notifications</span>
          </li>
          <li className={activeNav === 'sandbox' ? 'active' : ''} onClick={() => setActiveNav('sandbox')}>
            <SandboxIcon />
            <span>API Sandbox</span>
          </li>
          <li className={activeNav === 'billing' ? 'active' : ''} onClick={() => setActiveNav('billing')}>
            <BillingIcon />
            <span>Billing</span>
          </li>
          <li className={activeNav === 'docs' ? 'active' : ''} onClick={() => setActiveNav('docs')}>
            <DocsIcon />
      ...
      <div className="sidebar-footer">
        <div className="sidebar-footer-item" onClick={() => setActiveNav('settings')}>
          <SettingsIcon />
          <span>Settings</span>
        </div>
      </div>
